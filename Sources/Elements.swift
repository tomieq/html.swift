extension Node {
    ...
    public static func details(
        ...
        -> Node {
        return self.details(attributes: attributes, summary.rawValue, .fragment(content))
    }
    ...
    public static func form(enctype: Attribute<Tag.Form>.Enctype, attributes: [Attribute<Tag.Form>] = [], _ content: Node...) -> Node {
        return self.form(attributes: [.method(.post), .enctype(enctype)] + attributes, .fragment(content))
    }
    ...
    public static func img(src: String, alt: String, attributes: [Attribute<Tag.Img>] = []) -> Node {
        return self.img(attributes: [.src(src), .alt(alt)] + attributes)
    }
    ...
    public static func img(base64: String, type: MediaType, alt: String, attributes: [Attribute<Tag.Img>] = [])
        -> Node {
        return self.img(src: "data:\(type.description);base64,\(base64)", alt: alt, attributes: attributes)
    }
