...
extension ChildOf where Element == Tag.Head {
    ...
    public static func meta(contentType: MediaType) -> ChildOf {
        return self.meta(attributes: [.init("http-equiv", "content-type"), .content(contentType.description)])
    }

    public static func meta(defaultStyle: String) -> ChildOf {
        return self.meta(attributes: [.init("http-equiv", "default-stype"), .content(defaultStyle)])
    }

    public static func meta(refresh: Int) -> ChildOf {
        return self.meta(attributes: [.init("http-equiv", "refresh"), .content(String(refresh))])
    }

    public static func meta(applicationName: String) -> ChildOf {
        return self.meta(attributes: [.init("name", "application-name"), .content(applicationName)])
    }

    public static func meta(author: String) -> ChildOf {
        return self.meta(attributes: [.init("name", "author"), .content(author)])
    }
    ...
    public static func meta(keywords: [String]) -> ChildOf {
        ...
        return self.meta(attributes: [.init("name", "keywords"), .content(sanitizedKeywords.joined(separator: ","))])
    }

    public static func meta(name: String, content: String) -> ChildOf {
        return self.meta(attributes: [.init("name", name), .content(content)])
    }

    public static func meta(property: String, content: String) -> ChildOf {
        return self.meta(attributes: [.init("property", property), .content(content)])
    }
